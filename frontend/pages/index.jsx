  ...
  return (
    <div className="flex justify-center items-center">
      <div className="grid grid-cols-2 gap-8">
        <div
          onClick={() => router.push(`/vote/elections`)}
          className="p-8 text-center bg-vote-500 w-48 h-48 rounded-md text-white shadow-xl hover:bg-vote-600 transition ease-linear duration-200 cursor-pointer flex flex-col justify-center items-center"
        >
