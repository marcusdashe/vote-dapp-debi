...
function ElectionsIndex() {
  ...
  const getElections = async () => {
    try {
      ...
      console.log(
        "🚀 ~ file: allelections.js:37 ~ formattedElections ~ formattedElections",
        formattedElections
      );
          ...
          elections.map((election, idx) => {
            return (
              <div
                ...
                className="bg-vote-400 shadow-md shadow-gray-400 text-white text-center rounded-2xl py-2 cursor-pointer"
              >
